...
grid on
title('Electrostatic Potential @0V,300K')
xlabel('Position [\mum]')
...
grid on
title('Energy Band Diagram p-doped silicon @0V,300K')
legend('Conduction Band','Valence Band','p Quasi Fermi Level','Intrinsic Fermi Level')
xlabel('Position [\mum]')
ylabel('Energy [eV]')
...
title('Electron and hole concentrations p-doped silicon @0V,300K')
xlabel('Position [\mum]')
